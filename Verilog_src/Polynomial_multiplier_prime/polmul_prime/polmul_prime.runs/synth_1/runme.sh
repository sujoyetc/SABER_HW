...
HD_PWD='D:/SABER_FPGA/Verilog_src/Polynomial_multiplier_prime/polmul_prime/polmul_prime.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log poly_mul256_parallel_in2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source poly_mul256_parallel_in2.tcl
